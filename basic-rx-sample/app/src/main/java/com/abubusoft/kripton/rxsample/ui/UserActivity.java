...
package com.abubusoft.kripton.rxsample.ui;
...
import com.abubusoft.kripton.rxsample.Injection;
import com.abubusoft.kripton.rxsample.R;
...
public class UserActivity extends AppCompatActivity {
    ...
    protected void onStart() {
        ...
        // In case of error, log the exception.ddd
        mDisposable.add(mViewModel.getUserName()
                .subscribeOn(Schedulers.io())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(userName -> {
                            Logger.info("set new username ", userName);
