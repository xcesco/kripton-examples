...
public class TypeConvertersViewModel extends AndroidViewModel {
    ...
    public void createDb() {
        mDb = BindAppDataSource.getInstance();//.getInMemoryDatabase(this.getApplication());
    ...
    private void subscribeToDbChanges() {
        ...
        mBooks = mDb.getBookDao().findBooksBorrowedByNameAfter("Mike", yesterday);
    }
}
