...
/*
    ...
    private void addLoan(final BindAppDataSource db, final String id,
    ...
    private Book addBook(final BindAppDataSource db, final String id, final String title) {
        Book book = new Book();
        book.id = id;
        book.title = title;
    ...
    private User addUser(final BindAppDataSource db, final String id, final String name,
    ...
    private void populateWithTestData(BindAppDataSource db) {
...
/*
    private static class PopulateDbAsync extends BindAppAsynTask AsyncTask<Void, Void, Void> {
