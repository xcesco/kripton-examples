...
import com.example.android.persistence.codelab.db.BindAppDaoFactory;
...
public class DataSourcePopulator implements SQLitePopulator {
    ...
    private void addLoan(final BindAppDaoFactory daoFactory, final String id,
    ...
    private User addUser(final BindAppDaoFactory daoFactory, final String id, final String name,
